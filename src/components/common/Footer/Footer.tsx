export default function Footer() {
    return (
        <>
            <footer className="opacity-50 bg-white dark:bg-gray-900 fixed w-full z-20 bottom-0 left-0  ">
                <div className="max-w-screen-md flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between md:flex md:w-auto" id="navbar-user">
                        <ul className="flex font-medium p-4 space-x-4  md:bg-white dark:bg-gray-900 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
